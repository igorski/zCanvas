...
declare module "src/Sprite" {
    ...
    export default class Sprite extends DisplayObject<Sprite> {
        ...
        constructor({ resourceId, x, y, width, height, rotation, collidable, interactive, mask, sheet, sheetTileWidth, sheetTileHeight }: SpriteProps);
...
declare module "src/Collision" {
    ...
    export default class Collision {
        ...
        dispose(): void;
        getChildrenUnderPoint(sprites: Sprite[], x: number, y: number, width: number, height: number, collidablesOnly?: boolean): Sprite[];
