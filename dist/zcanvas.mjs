...
const l = { loadImage: (e2) => new Promise(async (s2, i2) => {
  ...
  var g2;
  n2 || (g2 = a2, function(t2) {
    const { location: e3 } = window;
    return !(!t2.startsWith("./") && !t2.startsWith(`${e3.protocol}//${e3.host}`)) || !/^http[s]?:/.test(t2);
  }(e2) || (g2.crossOrigin = "Anonymous"), r2.add(a2, "load", u2), r2.add(a2, "error", p2)), a2.src = e2, n2 && u2();
}), async loadBitmap(t2) {
...
function v(t2, e2) {
  ...
  return f = b > s2 ? g(f, h2 - (b - s2)) : g(h2, f - (s2 - b)), G = w > i2 ? g(G, n2 - (w - i2)) : g(n2, G - (i2 - w)), { src: { left: b > s2 ? 0 : s2 - b, top: w > i2 ? 0 : i2 - w, width: f, height: G }, dest: { left: b > s2 ? b - s2 : 0, top: w > i2 ? w - i2 : 0, width: f, height: G } };
}
function C(t2, e2, s2) {
...
const X = "transparent", R = 2 * Math.PI, y = 0.5;
...
class H {
  ...
  drawPath(t2, e2 = X, s2) {
    ...
    e2 !== X && this._ctx.fill(), s2 && (S(this._ctx, s2), this._ctx.stroke());
  }
  ...
  drawRect(t2, e2, s2, i2, h2 = X, n2, a2) {
    ...
    h2 !== X && (this._ctx.fillStyle = h2, this._ctx.fillRect(t2, e2, s2, i2)), n2 && (S(this._ctx, n2), this._ctx.strokeRect(y + t2, y + e2, s2, i2)), this.applyReset(o2);
  }
  drawRoundRect(t2, e2, s2, i2, h2, n2 = X, a2, o2) {
    const r2 = o2 ? this.prepare(o2, t2, e2, s2, i2) : 0;
    this._ctx.beginPath(), n2 !== X && (this._ctx.fillStyle = n2, this._ctx.roundRect(t2, e2, s2, i2, h2), this._ctx.fill()), a2 && (S(this._ctx, a2), this._ctx.roundRect(y + t2, y + e2, s2, i2, h2), this._ctx.stroke()), this.applyReset(r2);
  }
  drawCircle(t2, e2, s2, i2 = X, h2, n2) {
    const a2 = n2 ? this.prepare(n2, t2, e2, 2 * s2, 2 * s2) : 0;
    this._ctx.beginPath(), this._ctx.arc(t2 + s2, e2 + s2, s2, 0, R, false), i2 !== X && (this._ctx.fillStyle = i2, this._ctx.fill()), h2 && (S(this._ctx, h2), this._ctx.stroke()), this.applyReset(a2);
  }
  drawEllipse(t2, e2, s2, i2, h2 = X, n2, a2) {
    const o2 = a2 ? this.prepare(a2, t2, e2, 2 * s2, 2 * i2) : 0;
    this._ctx.beginPath(), this._ctx.ellipse(t2, e2, s2, i2, 0, 0, R, false), h2 !== X && (this._ctx.fillStyle = h2, this._ctx.fill()), n2 && (S(this._ctx, n2), this._ctx.stroke()), this.applyReset(o2);
  }
  drawImage(t2, e2, s2, i2, h2, n2) {
    if (!this._bmp.has(t2))
      return;
    const a2 = n2 ? this.prepare(n2, e2, s2, i2, h2) : 0;
    void 0 === i2 ? this._ctx.drawImage(this._bmp.get(t2), e2, s2) : this._ctx.drawImage(this._bmp.get(t2), e2, s2, i2, h2), this._debug && this.drawRect(e2, s2, i2, h2, X, { size: 1, color: "red" }), this.applyReset(a2);
  }
  drawImageCropped(t2, e2, s2, i2, h2, n2, a2, o2, r2, d2) {
    ...
    this._ctx.drawImage(this._bmp.get(t2), y + e2 << 0, y + s2 << 0, y + i2 << 0, y + h2 << 0, y + n2 << 0, y + a2 << 0, y + o2 << 0, y + r2 << 0), this._debug && this.drawRect(n2, a2, o2, r2, X, { size: 1, color: "red" }), this.applyReset(l2);
  }
  ...
  prepare(t2, e2, s2, i2, h2) {
    ...
    if (d2)
      ...
      return 0;
    if (l2) {
      const n3 = t2.scale ?? 1, a3 = ((_a = t2.pivot) == null ? void 0 : _a.x) ?? e2 + i2 * y, o3 = ((_b = t2.pivot) == null ? void 0 : _b.y) ?? s2 + h2 * y, r3 = t2.rotation * x, d3 = Math.cos(r3) * n3, l3 = Math.sin(r3) * n3;
...
const Y = "", K = "undefined" != typeof window && window.Blob && new Blob([atob(Y)], { type: "text/javascript;charset=utf-8" });
function z() {
  let t2;
  try {
...
class k {
  constructor(t2, e2 = false, s2 = false) {
    if (this._useW = false, this._el = t2, e2 && "function" == typeof this._el.transferControlToOffscreen) {
      ...
      this._wkr = new z(), this._wkr.postMessage({ cmd: "init", canvas: e3, debug: s2 }, [e3]), this._wkr.onmessage = this.handleMessage.bind(this);
    } else
      this._rdr = new H(this._el, s2);
  }
  loadResource(t2, e2) {
...
const M = { x: 0, y: 0 };
function F(t2, e2, s2, i2, h2) {
  return (t2 - e2) / (s2 - e2) * (h2 - i2) + i2;
}
const I = [], N = [], V = i(1, 1, true).cvs;
class P {
  constructor(t2) {
  ...
  pixelCollision(t2, e2) {
    ...
    if (void 0 === s2)
      return;
    this.getPixelArray(t2, s2, I), this.getPixelArray(e2, s2, N);
  ...
  async cache(t2) {
    ...
    n(V, e2, s2, i2);
    const { data: h2 } = V.getContext("2d").getImageData(0, 0, s2, i2), a2 = new Uint8Array(h2.length / 4);
    for (let t3 = 0, e3 = a2.length; t3 < e3; ++t3) {
      const e4 = h2[4 * t3 + 3];
      a2[t3] = e4 < 5 ? 0 : 1;
    }
    return this._cacheMap.set(t2, { mask: a2, size: { width: s2, height: i2 } }), V.width = V.height = 1, true;
  }
  clearCache(t2) {
  ...
  getPixelArray(t2, e2, s2) {
    ...
    s2.length = Z(o2 * r2);
    const c2 = l2.height, p2 = l2.width, u2 = n2 + o2, g2 = a2 + r2;
    let m2 = -1, _2 = 0;
    for (let t3 = a2; t3 < g2; ++t3)
...
class j extends J {
  constructor({ width: t2 = 300, height: e2 = 300, fps: s2 = 60, backgroundColor: i2 = null, animate: h2 = false, smoothing: n2 = true, stretchToFit: a2 = false, autoSize: o2 = true, viewport: r2 = null, preventEventBubbling: d2 = false, parentElement: l2 = null, debug: c2 = false, optimize: p2 = "auto", viewportHandler: u2, onUpdate: g2, onResize: m2 } = {}) {
        ...
        case "mouseup":
          ...
          if (this._isFs) {
            const e3 = function(t3, e4, s3, i3, h3) {
              ...
              return M.x = F(t3.clientX - s3.left - a3, 0, i3 * n3, 0, e4.width), M.y = F(t3.clientY - s3.top, 0, h3 * n3, 0, e4.height), M;
...
class T extends J {
  ...
  setBounds(t2, e2, s2, i2) {
    ...
    if (this._keepInBounds) {
      ...
      t2 = D(o2 - n2, B(t2, s3)), e2 = D(h3, B(e2, i3));
    } else
  ...
  invalidateDrawProps({ alpha: t2, scale: e2, rotation: s2, pivot: i2 }) {
    ...
    h2.alpha = t2 ?? h2.alpha, h2.scale = e2 ?? h2.scale, h2.rotation = s2 ?? h2.rotation, h2.pivot = i2 ?? h2.pivot, void 0 === s2 && void 0 === e2 || (this._tfb || (this._tfb = { ...this._bounds }), function(t3, e3, s3, i3) {
      if (0 === e3 && 1 === s3)
        return C(t3, 1, i3);
      const { left: h3, top: n2, width: a2, height: o2 } = C(t3, s3, i3);
      if (0 !== e3) {
        const t4 = -a2 * _, s4 = a2 * _, r2 = a2 * _, d2 = -a2 * _, l2 = o2 * _, c2 = o2 * _, p2 = -o2 * _, u2 = -o2 * _, b2 = e3 * x, w2 = Math.cos(b2), f2 = Math.sin(b2), G2 = t4 * w2 + l2 * f2, Z2 = -t4 * f2 + l2 * w2, v2 = s4 * w2 + c2 * f2, C2 = -s4 * f2 + c2 * w2, X2 = r2 * w2 + p2 * f2, R2 = -r2 * f2 + p2 * w2, y2 = d2 * w2 + u2 * f2, L2 = -d2 * f2 + u2 * w2, W2 = g(G2, v2, X2, y2), H2 = m(G2, v2, X2, y2), S2 = g(Z2, C2, R2, L2), Y2 = m(Z2, C2, R2, L2);
        i3.width = H2 - W2, i3.height = Y2 - S2, i3.left = h3 - (i3.width * _ - a2 * _), i3.top = n2 - (i3.height * _ - o2 * _);
      }
