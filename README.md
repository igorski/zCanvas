...
zCanvas has been written in modern vanilla JavaScript, comes with TypeScript annotations and works independently from (and thus works _with_) any other JavaScript framework.
